...
import allEvents from '../../../../../data/nextday.json';
import image1 from '../../../../../assets/images/event_images/image2.jpg';
...
const NextDay = () => {
    ...
    useEffect(() => {
        setAllDataset(allEvents.nextday);
    }, []);
    const actions = (
        <Row>
            <Col span={24}>
    ...
    const onSearch = (value: string) => {
        const filteredDataset = allEvents.nextday.filter((eventData) => {
            return (
                    ...
                    <Col span={24}>
                        <Row>
                            <Col span={24} className="eng-titlecontainer">
                                <span className="eng-profilename">Next Day</span>
                            </Col>
                        </Row>
