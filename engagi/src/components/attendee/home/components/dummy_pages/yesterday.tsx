...
import allEvents from '../../../../../data/yesterday.json';
...
const Yesterday = () => {
    ...
    useEffect(() => {
        setAllDataset(allEvents.yesterday);
    }, []);
    const actions = (
        <Row>
            <Col span={24}>
    ...
    const onSearch = (value: string) => {
        const filteredDataset = allEvents.yesterday.filter((eventData) => {
            return (
                    ...
                    <Col span={24}>
                        <Row>
                            <Col span={24} className="eng-titlecontainer">
                                <span className="eng-profilename">Yesterday</span>
                            </Col>
                        </Row>
